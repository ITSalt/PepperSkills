...
Основан на работе **«String Seed of Thought» (SSoT)** — Misaki & Akiba, Sakana AI, ICLR 2026.
...
Не применяйте SSoT к задачам с единственным правильным ответом: математика, фактология, отладка кода, классификация, перевод. Это добавляет шум и мешает модели.
...
MIT (ожидает — добавить файл LICENSE перед первым публичным релизом)
