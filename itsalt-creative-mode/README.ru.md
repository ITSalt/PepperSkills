...
Не применяйте `itsalt:creative-mode` к задачам с единственным правильным ответом: математика, фактология, отладка кода, классификация, перевод. Это добавляет шум и мешает модели.
