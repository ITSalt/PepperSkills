...
Based on **"String Seed of Thought" (SSoT)** — Misaki & Akiba, Sakana AI, ICLR 2026.
...
| NaCl framework | [`nacl/`](./nacl/) |

## When NOT to use

Do not apply SSoT to tasks with a single correct answer: math, factual lookup, code debugging, classification, translation. It adds noise without benefit and can distract the model.
...
MIT (pending — add LICENSE file before first public release)
