...
The canonical plugin is [`../plugins/pepper-prompt-engineer/`](../plugins/pepper-prompt-engineer/).
This path remains as a transition entry point; edit the canonical plugin only.
